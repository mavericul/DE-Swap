...
echo "================================================="
echo "   🌌 Universal Omni-Workspace Swapper v3.3      "
echo "================================================="
...
# Dynamic Menu Filtering (Excludes current workspace layout)
...
if [[ "$choice" -ge 1 && "$choice" -le "${#AVAILABLE_ENVS[@]}" ]]; then
    ...
    echo "Exiting interface. No adjustments made."
    exit 0
else
...
# =========================================================
# 4. DEEP PURGE PHASE (Executes FIRST to prevent cross-locks)
# =========================================================
echo "================================================="
read -p "🗑️ Do you want to completely uninstall $CURRENT_ENV first? (y/n): " purge_choice
echo "================================================="

if [[ "$purge_choice" =~ ^[Yy]$ ]]; then
    echo -e "\n🧹 Purging $CURRENT_ENV assets from storage..."
...
# =========================================================
# 5. UNIFIED INSTALLATION PHASE (Executes SECOND on a clean slate)
# =========================================================
...
# =========================================================
# 6. UNIFIED DISPLAY MANAGER (LOGIN SCREEN) ROUTER
# =========================================================
...
echo -e "\n🎉 Execution complete! Structural pipelines aligned."
